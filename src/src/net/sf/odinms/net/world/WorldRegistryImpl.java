...
public class WorldRegistryImpl extends UnicastRemoteObject implements WorldRegistry {
	...
	private Map<Integer, MapleAlliance>			alliances			= new LinkedHashMap<Integer, MapleAlliance>();			// contains
																															// id
																															// and
																															// alliance
																															// info.
	...
	public WorldChannelInterface registerChannelServer(String authKey, ChannelWorldInterface cb)
	...
	public String getStatus() throws RemoteException {
		...
		List<Entry<Integer, ChannelWorldInterface>> channelServers = new ArrayList<Entry<Integer, ChannelWorldInterface>>(
				channelServer.entrySet());
		...
		for (LoginWorldInterface lwi : loginServer) {
			...
			try {
				...
				ret.append(" users\n");
				int loginMinutes = (int) Math
						.ceil((double) loginInterval * ((double) lwi.getWaitingUsers() / lwi.getPossibleLoginAverage()))
						/ 60000;
