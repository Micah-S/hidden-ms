...
public class CouponCodeHandler extends AbstractMaplePacketHandler {
	...
	public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
		...
		if (validcode) {
			 ...
			 *
			 * Type 0: NX, Type 1: Maple Points, Type 2: Gift Tokens, Type 3: NX + Gift Tokens Type
			 * 4: Item Type 5: NX Coupon that can be used over and over
			 *
			 * When using Types 0-3, the item is the amount of NX or Maple Points you get. When
			 * using Type 4 the item is the ID of the item you get. Enjoy!
			 */
			switch (type) {
				case 0:
				case 1:
