	...
	public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
		...
		if (c.getPlayer().getRemainingAp() > 0) {
			switch (update) {
				...
				default:
					c.getSession()
							.write(MaplePacketCreator.updatePlayerStats(MaplePacketCreator.EMPTY_STATUPDATE, true));
					return;
			}
			...
			// + update + " without having any");
			log.info("[h4x] Player {} is distributing AP to {} without having any", c.getPlayer().getName(),
