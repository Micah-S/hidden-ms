...
public class PartySearchHandler extends AbstractMaplePacketHandler {
	...
	// All bolleans as for now, all is useless... just for testing somehow, but I changed method
	// while making
	boolean				All					= false, Beginner = false, AllWarriors = false, Warrior1 = false,
			Warrior2 = false, Warrior3 = false, AllMagician = false, Magician1 = false, Magician2 = false,
			Magician3 = false, AllPirate = false, Pirate1 = false, Pirate2 = false, AllThief = false, Thief1 = false,
			Thief2 = false, AllBowman = false, Bowman1 = false, Bowman2 = false;
