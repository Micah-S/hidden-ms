	...
	public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
		...
		while (iter.hasNext()) {
			...
			if (summon.isPuppet() && summon.getOwner() == player) {
				...
				c.getPlayer().getMap().broadcastMessage(player, MaplePacketCreator.damageSummon(player.getId(),
						summon.getSkill(), damage, unkByte, monsterIdFrom), summon.getPosition());
				break;
			}
		}
	}
