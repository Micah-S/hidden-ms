...
public class MonsterCarnivalHandler extends AbstractMaplePacketHandler {
	...
	public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
		...
		if (tab == 0) {
			...
			// c.getPlayer().getMap().spawnMonsterOnGroundBelow(mob,
			// randomizePosition(c.getPlayer().getMapId()));
	...
	public int getMonsterIdByNum(int num) {
		/*
		 * 1 - Brown Teddy - 3000005 2 - Bloctopus - 3230302 3 - Ratz - 3110102 4 - Chronos -
		 * 3230306 5 - Toy Trojan - 3230305 6 - Tick-Tock - 4230113 7 - Robo - 4230111 8 - King
		 * Bloctopus - 3230103 9 - Master Chronos - 4230115 10 - Rombot - 4130103
		 */
		int mid = 0;
		num++;
