...
public class Extras implements Command {
	...
	public CommandDefinition[] getDefinition() {
		return new CommandDefinition[] { new CommandDefinition("cody", 0), new CommandDefinition("storage", 0),
				new CommandDefinition("news", 0), new CommandDefinition("kin", 0), new CommandDefinition("nimakin", 0),
