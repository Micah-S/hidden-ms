...
public class ClanHolder {
	...
	private Map<MapleCharacter, Integer>	online	= new LinkedHashMap<MapleCharacter, Integer>();	// Only
																									// for
																									// each
																									// channel
																									// sadly..
	private static Map<String, Integer>		offline	= new LinkedHashMap<String, Integer>();			// Only
																									// contains
																									// name..
