...
public class MapleLifeFactory {
	...
	private static MapleDataProvider				stringDataWZ	= MapleDataProviderFactory
	...
	public static void decodeElementalString(MapleMonsterStats stats, String elemAttr) {
		for (int i = 0; i < elemAttr.length(); i += 2) {
			...
			ElementalEffectiveness ee = ElementalEffectiveness
					.getByNumber(Integer.valueOf(String.valueOf(elemAttr.charAt(i + 1))));
